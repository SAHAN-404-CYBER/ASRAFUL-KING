...
.'   \_.'  \ \._,\ '/| '.    | '.\ \._,\ '/|  |   |  | 
            `--'  `" '---'   '---'`--'  `" '--'   '--' 
\033[0;94m╠═══════════════════════════════════════════════════
\033[0;93m╠══[Author:==================> \33[1;38mSAHAN CYBER\33[1;38m       \033[1;31m
╠══[Facebook:================> Asraful Ahmed Sahan
╠══[Github:==================> \33[1;38mSAHAN-404-CYBER      \33[1;34m
╠══[Whatsapp:================> 01401648565     \33[1;35m
╠══[TOOLS:===================> Random Cloning  ║ \33[1;32m
╠══[VERSION:=================> 2.0.3           \033[1;35m
\033[0;92m╚═══════════════════════════════════════════════════\033[1;31m
    """) 
loop = 0
oks = []
...
def xxr():
    ...
    HamiiID = []
    print("")
    for sahan in range(passx):
        pww = input(f"[*] Enter Password {sahan+1} : ")
        HamiiID.append(pww)
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(f'\033[0;97m[{xr}^{x}]\033[0;93m WORK IN WIFI & DATA ')
